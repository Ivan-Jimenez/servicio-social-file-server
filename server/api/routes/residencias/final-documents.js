...
const FinalDocumentsController = require('../../controllers/residencias/final-documents')
...
.fields([
  // TODO: Replace with the final documents name for residencias
  { name: 'evaluacion' },
...
router.get('/:residenciaId', FinalDocumentsController.getOne)

/** Fetch all final documents */
router.get('/', FinalDocumentsController.getAll)

/** Delete final documents */
router.delete('/:residenciaId', FinalDocumentsController.deleteOne)
